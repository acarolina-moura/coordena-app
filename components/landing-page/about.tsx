...
<<<<<<< HEAD
    return (
        <section
            id="sobre-nos"
            className="py-20 bg-white dark:bg-slate-950 overflow-hidden border-t border-slate-100 dark:border-slate-900"
        >
                ...
                <div className="flex flex-col items-center gap-20">
                    ...
                    >
                        <div className="flex flex-col gap-5">
                            <span className="text-blue-600 dark:text-blue-400 font-extrabold uppercase tracking-[0.3em] text-sm">
                                Sobre nós
                            </span>
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full pt-4">
                            {[
                                {
                                ...
                                <div
                                    key={i}
                                    className="flex flex-col items-center text-center gap-4 p-6 rounded-3xl bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800 transition-all duration-300 hover:shadow-xl hover:shadow-slate-200/50 dark:hover:shadow-none hover:-translate-y-1"
                                >
                                    <div
                                        className={cn(
                                ...
                                <div className="p-4 md:p-8 space-y-6 md:space-y-8 flex-1 overflow-hidden">
                                    <div className="grid grid-cols-3 gap-4 md:gap-6">
                                        ...
                                        <div className="h-20 md:h-24 bg-purple-50/50 dark:bg-purple-900/10 border border-purple-100/50 dark:border-purple-800/30 rounded-2xl p-4 flex flex-col justify-end gap-1">
                                            <span className="text-[10px] font-black text-purple-600/60 uppercase tracking-wider">
                                                Turmas
                                            </span>
                                        ...
                                        <div className="h-20 md:h-24 bg-emerald-50/50 dark:bg-emerald-900/10 border border-emerald-100/50 dark:border-emerald-800/30 rounded-2xl p-4 flex flex-col justify-end gap-1">
                                            <span className="text-[10px] font-black text-emerald-600/60 uppercase tracking-wider">
                                                Média Geral
                                            </span>
                                            ...
                                            {[
                                                ...
                                                >
                                                    <div className="w-full flex items-end gap-1 px-0.5 h-20 md:h-28">
                                                        <div
                                                            className="flex-1 bg-blue-600/40 rounded-t-[4px]"
                                                            style={{
                                                                height: day.h1,
                                                            }}
                                                        />
                                                        <div
                                                            className="flex-1 bg-slate-200 dark:bg-slate-800 rounded-t-[4px]"
                                                            style={{
                                                                height: day.h2,
                                                            }}
                                                        />
...
=======
  return (
    <section id="sobre-nos" className="py-16 sm:py-20 bg-white dark:bg-slate-950 overflow-hidden border-t border-slate-100 dark:border-slate-900">
        ...
        <div className="flex flex-col items-center gap-12 sm:gap-16 lg:gap-20">
          ...
          >
            <div className="flex flex-col gap-4 sm:gap-5">
              <span className="text-blue-600 dark:text-blue-400 font-extrabold uppercase tracking-[0.2em] sm:tracking-[0.3em] text-xs sm:text-sm">Sobre nós</span>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 w-full pt-2 sm:pt-4">
              {[
                ...
                <div key={i} className="flex flex-col items-center text-center gap-2 sm:gap-3 p-3 sm:p-4 lg:p-6 rounded-xl sm:rounded-2xl lg:rounded-3xl bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800 transition-all duration-300 hover:shadow-xl hover:shadow-slate-200/50 dark:hover:shadow-none hover:-translate-y-1">
                  <div className={cn(
                  ...
                  <div className="space-y-0.5 sm:space-y-1">
                    <h4 className="font-extrabold text-slate-900 dark:text-white text-xs sm:text-sm lg:text-base tracking-tight">{item.title}</h4>
                    <p className="text-[10px] sm:text-xs text-slate-500 leading-snug line-clamp-2">{item.desc}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="relative w-full z-10 bg-white/95 dark:bg-slate-950/95 backdrop-blur-xl rounded-2xl sm:rounded-3xl md:rounded-[40px] border border-slate-200 dark:border-slate-800 shadow-2xl p-0 overflow-hidden flex min-h-[280px] sm:min-h-[320px] md:min-h-[450px]">
              ...
              <div className="w-10 sm:w-12 md:w-16 border-r border-slate-200 dark:border-slate-800 flex flex-col items-center py-4 sm:py-6 md:py-8 gap-4 sm:gap-6 md:gap-8 bg-slate-50/50 dark:bg-slate-900/50">
                ...
                <div className="flex flex-col gap-4 sm:gap-5 md:gap-6 text-slate-400 dark:text-slate-500">
                   <div className="text-blue-600"><Home className="w-4 h-4 sm:w-5 sm:h-5" /></div>
                ...
                <div className="p-3 sm:p-4 md:p-8 space-y-4 sm:space-y-6 md:space-y-8 flex-1 overflow-hidden">
                  <div className="grid grid-cols-3 gap-2 sm:gap-4 md:gap-6">
                    <div className="h-16 sm:h-20 md:h-24 bg-blue-50/50 dark:bg-blue-900/10 border border-blue-100/50 dark:border-blue-800/30 rounded-xl sm:rounded-2xl p-2 sm:p-4 flex flex-col justify-end gap-1">
                       <span className="text-[8px] sm:text-[10px] font-black text-blue-600/60 uppercase tracking-wider">Alunos Ativos</span>
                       <span className="text-base sm:text-xl md:text-2xl font-black text-blue-600">842</span>
                    </div>
                    <div className="h-16 sm:h-20 md:h-24 bg-purple-50/50 dark:bg-purple-900/10 border border-purple-100/50 dark:border-purple-800/30 rounded-xl sm:rounded-2xl p-2 sm:p-4 flex flex-col justify-end gap-1">
                       <span className="text-[8px] sm:text-[10px] font-black text-purple-600/60 uppercase tracking-wider">Turmas</span>
                       <span className="text-base sm:text-xl md:text-2xl font-black text-purple-600">24</span>
                    </div>
                    <div className="h-16 sm:h-20 md:h-24 bg-emerald-50/50 dark:bg-emerald-900/10 border border-emerald-100/50 dark:border-emerald-800/30 rounded-xl sm:rounded-2xl p-2 sm:p-4 flex flex-col justify-end gap-1">
                       <span className="text-[8px] sm:text-[10px] font-black text-emerald-600/60 uppercase tracking-wider">Média Geral</span>
                       <span className="text-base sm:text-xl md:text-2xl font-black text-emerald-600">8.2</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-slate-50/50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-2xl sm:rounded-3xl p-3 sm:p-4 md:p-6 h-28 sm:h-32 md:h-48 flex flex-col gap-2 sm:gap-4">
                     <div className="flex items-center justify-between">
                        <span className="text-[8px] sm:text-[10px] font-black text-slate-400 uppercase tracking-widest">Desempenho Semanal</span>
                        ...
                        {[
                          ...
                          <div key={i} className="flex-1 flex flex-col items-center gap-1 sm:gap-2 h-full justify-end">
                            <div className="w-full flex items-end gap-0.5 sm:gap-1 px-0.5 h-16 sm:h-20 md:h-28">
                               <div className="flex-1 bg-blue-600/40 rounded-t-[3px] sm:rounded-t-[4px]" style={{ height: day.h1 }} />
                               <div className="flex-1 bg-slate-200 dark:bg-slate-800 rounded-t-[3px] sm:rounded-t-[4px]" style={{ height: day.h2 }} />
                            </div>
                            <span className="text-[7px] sm:text-[9px] font-bold text-slate-400">{day.l}</span>
                          </div>
                        ))}
                     </div>
                  </div>
