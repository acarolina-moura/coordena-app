        ...
        >
            <div className="max-w-7xl mx-auto flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center gap-4">
                    ...
                    <Button
                        asChild
                        className="bg-blue-600 hover:bg-blue-700 text-white rounded-xl px-6 font-bold shadow-lg shadow-blue-600/20 active:scale-95 transition-all"
                    >
                        <Link
                            href="/register"
                ...
                {mobileMenuOpen && (
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <Button
                                asChild
                                className="w-full justify-start font-bold rounded-xl bg-blue-600 hover:bg-blue-700 text-white"
                            >
                                <Link
                                    href="/register"
                                    onClick={() => setMobileMenuOpen(false)}
