...
export function Hero() {
  return (
    <section id="home" className="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden bg-white dark:bg-slate-950">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-purple-400/20 dark:bg-purple-600/10 rounded-full blur-[120px] animate-pulse" style={{ animationDelay: '2s' }} />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center flex flex-col items-center gap-10">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed font-medium">
            Simplificamos a gestão académica com ferramentas intuitivas para coordenadores, professores e alunos. Tudo num só lugar, com máxima clareza e eficiência.
          </p>
        </motion.div>
        ...
        >
          ...
          <Button variant="outline" className="w-full sm:w-auto h-16 px-10 rounded-2xl border-2 border-slate-200 dark:border-slate-800 bg-white/50 dark:bg-slate-900/50 backdrop-blur-md font-black text-xl active:scale-95 transition-all text-slate-900 dark:text-white">
            Ver Demo
          </Button>
        </motion.div>
        ...
        >
          {[
            ...
            <div key={i} className="flex items-center gap-3 text-base font-bold text-slate-500 dark:text-slate-400">
