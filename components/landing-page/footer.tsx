    ...
    <footer className="bg-slate-900 text-slate-300 pt-20 pb-10 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-6">
            ...
            <p className="text-slate-400 text-sm leading-relaxed max-w-xs">
              A solução definitiva para a gestão escolar inteligente. Revolucionando a educação digital um módulo de cada vez.
            </p>
            <div className="flex items-center gap-4">
               {[Facebook, Twitter, Instagram, Linkedin].map((Icon, i) => (
                 <a key={i} href="#" className="h-10 w-10 rounded-full border border-slate-700 flex items-center justify-center hover:bg-blue-600 hover:border-blue-600 hover:text-white transition-all transform hover:-translate-y-1">
          ...
          {/* Links Column 1 */}
          <div className="flex flex-col gap-6">
            <h4 className="text-white font-bold text-lg">Produto</h4>
            <ul className="flex flex-col gap-3 text-sm font-medium">
                <li><Link href="#home" className="hover:text-blue-400 transition-colors">Home</Link></li>
                <li><Link href="#funcionalidades" className="hover:text-blue-400 transition-colors">Funcionalidades</Link></li>
                <li><Link href="#sobre-nos" className="hover:text-blue-400 transition-colors">Sobre nós</Link></li>
                <li><Link href="#criadores" className="hover:text-blue-400 transition-colors">Criadores</Link></li>
            </ul>
          </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <ul className="flex flex-col gap-3 text-sm font-medium">
                <li><Link href="#" className="hover:text-blue-400 transition-colors">Documentação</Link></li>
                <li><Link href="#" className="hover:text-blue-400 transition-colors">Centro de Ajuda</Link></li>
        ...
        <div className="pt-10 border-t border-slate-800 flex flex-col md:flex-row items-center justify-between gap-6 text-xs font-bold uppercase tracking-widest text-slate-500">
          <p>© {currentYear} CoordenaApp. Todos os direitos reservados.</p>
