...
const features = [
  {
    ...
    description: "Lançamento e cálculo automático de médias por módulo e semestre.",
    icon: BarChart3,
    color: "blue",
  },
  {
    title: "Assiduidade Digital",
    description: "Controle de presenças simplificado com relatórios em tempo real.",
    icon: ClipboardCheck,
    color: "emerald",
  },
  {
    title: "Cronograma Dinâmico",
    description: "Organização de horários e eventos escolares integrada para toda a equipa.",
    icon: Calendar,
    color: "purple",
  },
  {
    title: "Relatórios Acadêmicos",
    description: "Gere PDFs detalhados de desempenho e progresso dos alunos.",
    icon: PieChart,
    color: "blue",
  },
  {
    title: "Trabalhos e Tarefas",
    description: "Submissão e correção de trabalhos diretamente na plataforma.",
    icon: FileText,
    color: "emerald",
  },
  {
    title: "Comunicação Interna",
    description: "Chat e avisos para manter professores e encarregados informados.",
    icon: MessageSquare,
    color: "purple",
  },
  {
    title: "Biblioteca de Apoio",
    description: "Repositório de materiais didáticos e documentos importantes.",
    icon: BookOpen,
    color: "blue",
  },
  {
    title: "Painel Financeiro",
    description: "Acompanhamento de mensalidades e pagamentos de forma integrada.",
    icon: Wallet,
    color: "emerald",
  },
];
