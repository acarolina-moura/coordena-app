      ...
      <div className="relative" ref={dropdownRef}>
        ...
        >
          <Bell
            className={cn(
              "h-5 w-5",
              open ? "text-indigo-600" : "text-gray-500",
            )}
          />
          {naoLidas.length > 0 && (
        ...
        {/* Dropdown */}
        {open && (
          <div className="absolute right-0 top-12 z-50 w-[360px] rounded-2xl border border-gray-200 bg-white shadow-xl">
            {/* Header dropdown */}
                      ...
                      >
                        <span
                          className={cn(
                            ...
                            isLida && "font-medium text-gray-600",
                          )}
                        >
                          {notif.titulo}
                        </span>
                        ...
                        {notif.urgente && !isLida && (
                          <span className="mt-0.5 w-fit rounded-full bg-red-100 px-2 py-0.5 text-[10px] font-bold text-red-600">
                            Urgente
                          </span>
                        )}
                      </Link>
