            ...
            {modulos.map(modulo => (
                ...
                >
                    <div className="flex justify-between items-start gap-4">
                        ...
                        {modulo.hasReview && (
                            <div className="flex items-center gap-1.5 text-green-600 dark:text-green-500 bg-green-50 dark:bg-green-900/30 px-3 py-1 rounded-full text-xs font-bold">
                    ...
                    {!modulo.hasReview || editingId === modulo.id ? (
                        ...
                        <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-4 space-y-3 relative group">
                            <button
                                ...
                                className="absolute top-4 right-4 text-gray-300 dark:text-gray-600 hover:text-teal-600 dark:hover:text-teal-500 transition-colors opacity-0 group-hover:opacity-100"
    ...
    return (
        <div className="space-y-4 flex-1 flex flex-col">
            <div className="flex flex-col gap-1.5">
                <span className="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Classificação</span>
            ...
            <div className="flex flex-col gap-1.5 flex-1">
                <span className="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider">O teu comentário</span>
            ...
            <div className="flex gap-2">
                {onCancel && (
                    <Button
                        ...
                        onClick={onCancel}
                        disabled={loading}
                        className="flex-none rounded-xl h-11 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800"
                    >
                        Cancelar
                    </Button>
                )}
