                ...
                prev.map((m) =>
                    m.id === moduloId
                        ? {
                              ...m,
                              hasReview: true,
                              review: { nota, comentario, data: new Date() },
                          }
                        : m,
                ),
            );
                ...
                >
                    ...
                    {!modulo.hasReview || editingId === modulo.id ? (
                        <ReviewForm
                            ...
                            onSubmit={(nota, msg) =>
                                handleSubmit(modulo.id, nota, msg)
                            }
                            loading={submitting === modulo.id}
                            hoveredIdx={
                                hoveredModId === modulo.id ? hoveredStar : null
                            }
                            setHoveredIdx={(star) => {
                                setHoveredModId(
                                    star !== null ? modulo.id : null,
                                );
                                setHoveredStar(star);
                            }}
                            onCancel={
                        ...
                        >
                            <Star
                                className={cn(
                                    ...
                                    (hoveredIdx !== null && hoveredIdx >= s) ||
                                        (hoveredIdx === null && s <= nota)
                                        ? "fill-amber-400 text-amber-400"
                                        : "text-gray-200 dark:text-gray-700",
                                )}
                            />
