  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <h1 className="text-[26px] font-bold text-gray-900">Assiduidade</h1>
      ...
      {filtrados.length === 0 ? (
        ...
        <div className="rounded-2xl border border-gray-200 bg-white overflow-hidden">
          {/* Table header */}
          <div className="grid grid-cols-[1fr_160px_80px_80px_80px_140px] gap-4 px-5 py-3 border-b border-gray-100 bg-gray-50">
          ...
          <div className="flex flex-col divide-y divide-gray-50">
            {filtrados.map((d) => {
              ...
              return (
                <div
                  key={d.id}
                  className="grid grid-cols-[1fr_160px_80px_80px_80px_140px] gap-4 items-center px-5 py-3.5 hover:bg-gray-50 transition-colors"
                >
                  {/* Nome */}
