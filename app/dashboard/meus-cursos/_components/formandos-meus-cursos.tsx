...
import type { MeusCursos } from "../../_data/formando";
import type { StatusCurso } from "@prisma/client";

// ─── Types ────────────────────────────────────────────────────────────────────

type MeuCurso = MeusCursos extends (infer T)[] ? T : never;
            ...
            <div className="px-6 py-5">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <Progress
                        ...
                        className="h-2 bg-gray-100 dark:bg-gray-800 [&>*]:bg-teal-400"
                    />
                </div>
            </div>
            ...
            {expanded && (
                <div className="border-t border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/20 px-6 py-4">
                    ...
                    <div className="flex flex-col gap-3">
                        {curso.modulos.map((mod: Modulo) => {
                            return (
                                <div
                                    key={mod.id}
                                    className="flex items-center gap-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-4 py-3"
                                >
                                    {/* Icon */}
